...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2015 at 12:06 PM
...
INSERT INTO `nilai_kp` (`id`, `nim`, `id_pengajuanpembkp`, `pemb_lapangan`, `nilai_pemblapangan`, `file_nilai`, `kesesuaian_laporan`, `penguasaan_materi`, `analisis_perancangan`, `sikap_etika`, `nilai_dosbing`) VALUES
(3, '09111003024', 4, 'Cipta', 89, 'nilaikplapangan/Formulir_Pendaftaran_Beasiswa.pdf.pdf', 0, 0, 0, 0, 0);
...
(9, '09111003075', '12345678', 'PT. Pertamina (Persero)', '2015', 'diajukan'),
(10, '09111003022', '197210182008121001', 'PT. Semen Baturaja(Persero)', '2015', 'diajukan'),
...
(11, 'admin_indralaya', '$2y$10$xjFplltitavluTjg4HxJI.0JTGUcR/WH5SKoOkz1yclL4XDoVy8t2', 'admin', 'K7Fgs7grrwBHYGG1V7iBJ04Qle4D4fxjC7iWUmHWJhgh1Q41h7ithQMtmXV4'),
(42, 'kajur_SI', '$2y$10$hk.vPJNn7qxJGy0N22xaQeYwhFukQuomKKo4smuxlgVTxDAeU8qLq', 'ketua jurusan', 'ta5jXYvfXWwBcK1hX8UiemGK52wIb42ZyAGJnsIwhfnEP8ANCeIZtFl7OcUa'),
...
(44, 'admin_bukit', '$2y$10$F9./kbVCyIwNqHzKitM.iOGZkc3PIkwAT7.gijcUgUUQFpiyL78Z2', 'admin', 'UotkBITqC5KXg7qHzPHKgtqNmp1mxp9C7P9q0qkJjv5FS7vPqKpN66jBaU6p'),
(47, '197210182008121001', '$2y$10$dmdbKjsyXXYczUqwaV8KEeo1BOQgAnniHBpO5WlHBc3opVVPu7TY2', 'dosen', 'Jkn2NLoGUJ3HELkR7DkM7YxBczVVgdKha63Xrvu8Acq2QmsjffpBSfVRDeSU'),
(48, '09111003024', '$2y$10$IG03FmjMEZlgDasVZPz2wuO4QdDD7TPSB3cRQIds7R0jrnVfyC.zy', 'mahasiswa', 'wEnxKwtMVVH7K9FFlR6TEnTozHtCftkAyXbrN2Dtm2r69ppVUSmLo9FVVljY'),
(49, '09111003036', '$2y$10$ptE009n/pb9tbSeH4PgqJuslNdhLpddkBrXMQAVoY2uFnoSgc8cZ.', 'mahasiswa', 'GMaQ84urIUS1yOZg0PVqHucjwpWA3eUd3huSXWBG2yt6zkk0Jj40UHCLLWBh'),
(50, '12345678', '$2y$10$3TYuc7yDQIpKHzoZvZ0KvOloe17UCS4kxf/6GlbkWqRo4pu5Tk0Dy', 'dosen', '7066bzUba6ph4uPcz1X147u5iZTQwhPYfQkI2p1zO0PvUGQaFA7ogZDozfQc'),
(51, '09111003016', '$2y$10$I.E/vJpHmot6ua/3AQWHleeCYrWCipiBDA7.IeJD.5jJEcqSEnbiW', 'mahasiswa', 'J9xaqraAzeBBEKTmIoQIJ0vmeC97cqTpUFZ9osKxls8KHFEdzpv5935aydqX'),
