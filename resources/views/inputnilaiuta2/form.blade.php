		...
		<div class="form-group">
			...
			{!! Form::text('presentasi',@$nilaiuta2->presentasi,['class'=>'form-control','id'=>'presentasi'])!!}
		...
		<div class="form-group">
			...
			{!! Form::text('format_penulisan',@$nilaiuta2->format_penulisan,['class'=>'form-control','id'=>'format_penulisan'])!!}
			<span style="font-size:10pt; color:red;">Bobot nilai 5%</span>
		</div>

		<div class="form-group">
			{!! Form::label('penggunaan_bahasa','Penggunaan Bahasa Indonesia yang baik dan benar :') !!}
			{!! Form::text('penggunaan_bahasa',@$nilaiuta2->penggunaan_bahasa,['class'=>'form-control','id'=>'penggunaan_bahasa']) !!}
			<span style="font-size:10pt; color:red;">Bobot nilai 5%</span>
		</div>

		<div class="form-group">
			{!! Form::label('kesesuaian','Kesesuaian analisis, desain, implementasi, dan pengujian :') !!}
			{!! Form::text('kesesuaian',@$nilaiuta2->kesesuaian,['class'=>'form-control','id'=>'kesesuaian']) !!}
			<span style="font-size:10pt; color:red;">Bobot nilai 5%</span>
		</div>

		<div class="form-group">
			{!! Form::label('kelengkapan_dokumen','Kelengkapan dokumen pendukung/lampiran :') !!}
			{!! Form::text('kelengkapan_dokumen',@$nilaiuta2->kelengkapan_dokumen,['class'=>'form-control','id'=>'kelengkapan_dokumen']) !!}
			<span style="font-size:10pt; color:red;">Bobot nilai 5%</span>
		</div>
		...
		<div class="form-group">
			...
			{!! Form::text('analisa_perancangan',@$nilaiuta2->analisa_perancangan,['class'=>'form-control','id'=>'analisa_perancangan'])!!}
		...
		<div class="form-group">
			...
			{!! Form::text('pemrograman',@$nilaiuta2->pemrograman,['class'=>'form-control','id'=>'pemrograman']) !!}
			<span style="font-size:10pt; color:red;">Bobot nilai 20%</span>
		</div>

		<div class="form-group">
			{!! Form::label('basisdata','Basisdata/Hasil akhir pembahasan kasus :') !!}
			{!! Form::text('basisdata',@$nilaiuta2->basisdata,['class'=>'form-control','id'=>'basisdata']) !!}
		...
		<div class="form-group">
			...
			{!! Form::text('paket_perkantoran',@$nilaiuta2->paket_perkantoran,['class'=>'form-control','id'=>'paket_perkantoran'])!!}
			<span style="font-size:10pt; color:red;">Bobot nilai 5%</span>
		</div>

		<div class="form-group">
			{!! Form::label('perangkat_keras','Perangkat Keras Komputer dan Sistem Operasi :') !!}
			{!! Form::text('perangkat_keras',@$nilaiuta2->perangkat_keras,['class'=>'form-control','id'=>'perangkat_keras']) !!}
			<span style="font-size:10pt; color:red;">Bobot nilai 5%</span>
		</div>

		<div class="form-group">
			{!! Form::label('jarkom','Jaringan Komputer :') !!}
			{!! Form::text('jarkom',@$nilaiuta2->jarkom,['class'=>'form-control','id'=>'jarkom']) !!}
			<span style="font-size:10pt; color:red;">Bobot nilai 5%</span>
		</div>

		<div class="form-group">
			{!! Form::label('sikap_etika','Sikap dan Etika :') !!}
			{!! Form::text('sikap_etika',@$nilaiuta2->sikap_etika,['class'=>'form-control','id'=>'sikap_etika']) !!}
			<span style="font-size:10pt; color:red;">Bobot nilai 10%</span>
		</div>

		<div class="form-group">
			{!! Form::label('penilaian_proses','Penilaian Proses :') !!}
			{!! Form::text('penilaian_proses',@$nilaiuta2->penilaian_proses,['class'=>'form-control','id'=>'penilaian_proses']) !!}
