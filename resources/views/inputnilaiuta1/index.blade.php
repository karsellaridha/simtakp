...
<div class="box">
                <div class="box-header">
                  <h3 class="box-title">Detail Nilai Ujian Proposal Mahasiswa</h3>
                </div><!-- /.box-header -->
...
@if (count($inputnilaiuta1)>0)
<table border="0" class="table">
  <tr>
    <td>Penyajian/Presentasi</td>
    <td>:</td>
    <td>{!! $inputnilaiuta1->presentasi !!}</td>
  </tr>
  ...
  <tr>
    ...
    <td>:</td>
    <td>{!! $inputnilaiuta1->paket_perkantoran !!}</td>
  </tr>

  <tr>
    <td>Perangkat Keras Komputer dan Sistem Operasi</td>
    <td>:</td>
    <td>{!! $inputnilaiuta1->perangkat_keras !!}</td>
  </tr>

  <tr>
    <td>Jaringan Komputer</td>
    <td>:</td>
    <td>{!! $inputnilaiuta1->jarkom !!}</td>
  </tr>

  <tr>
    <td>Sikap dan Etika</td>
    <td>:</td>
    <td>{!! $inputnilaiuta1->sikap_etika !!}</td>
  </tr>

  <tr>
    <td>JUMLAH</td>
    <td>:</td>
    <td>{!! $inputnilaiuta1->jumlah !!}</td>
  </tr>

  <tr>
    <td>Penilaian Proses</td>
    <td>:</td>
    <td>{!! $inputnilaiuta1->penilaian_proses !!}</td>
  </tr>
