...
<h3><b><center>
  <p>BERITA ACARA UJIAN KOMPREHENSIF </p>
</center></h3>
<center><table width="712" border="0">
  <tr>
    <td colspan="3"><div align="justify">Pada Hari tanggal {!! date('d-M-Y',strtotime($tanggal)) !!}, telah dilaksanakan ujian komprehensif mahasiswa :</div></td>
    </tr>
  <tr>
    <td width="210"><div align="left">Nama Mahasiswa</div></td>
    <td width="19"><div align="center">:</div></td>
    <td width="461">{!! $ujianta2->mahasiswa->nama !!}</td>
  </tr>
  <tr>
...
<center><table width="710" border="1">
  <tr>
    ...
    <td width="222"><div align="center">Nama Penguji</div></td>
    <td width="218"><div align="center">Status Penguji</div></td>
    <td width="208"><div align="center">Tanda Tangan</div></td>
  </tr>
  <tr>
  ...
  <table width="703" border="0">
    <tr>
      <td colspan="2"><div align="right">Palembang, {!! date('d-M-Y',strtotime($tanggal)) !!}</div></td>
    </tr>
    <tr>
      <td width="359">Mengatahui</td>
      <td width="334">&nbsp;</td>
    </tr>
    <tr>
      <td>Ketua Jurusan,</td>
    ...
    <tr>
      ...
      <td>{!! $pengajuan->ppta->data_pembimbing_1->nip!!}</td>
    </tr>
  </table>
  <p>&nbsp;</p>
</center>
