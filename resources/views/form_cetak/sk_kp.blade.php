...
<table width="915" border="0">
    ...
    <tr>
      <td colspan="6"><div align="center"><strong>Nomor :{!! @$pskp->verifikasi->no_sk !!}/UN9.1.9/PP/{!! date('Y',strtotime($tanggal)) !!}</strong></div></td>
    </tr>
    <tr>
      <td colspan="6">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td colspan="6"><div align="center">PENGANGKATAN DOSEN PEMBIMBING KERJA PRAKTEK(KP) MAHASISWA</div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3"><div align="justify">Bahwa mahasiswa Jurusan Sistem Informasi Fakultas Ilmu Komputer Universitas Sriwijaya akan membuat Kerja Praktek sebagai salah satu syarat untuk.</div></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><div align="center"></div></td>
      <td><div align="center">b.</div></td>
      <td colspan="3"><div align="justify">Bahwa agar pelaksanaan pembuatan laporan Kerja Praktek tersebut dapat terlaksana dengan baik dan lancar, perlu menunjuk dosen pembimbing;</div></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>Menetapkan</td>
      <td><div align="center">:</div></td>
      <td colspan="4"><div align="justify">KEPUTUSAN DEKAN FAKULTAS ILMU KOMPUTER UNIVERSITAS SRIWIJAYA TENTANG PENGANGKATAN DOSEN PEMBIMBING KERJA PRAKTEK (KP) MAHASISWA JURUSAN SISTEM INFORMASI FAKULTAS ILMU KOMPUTER UNIVERSITAS SRIWIJAYA</div></td>
    </tr>
    <tr>
      <td colspan="6">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td colspan="4">Sebagai Pembimbing Untuk Membimbing Kerja Praktek Mahasiswa</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
