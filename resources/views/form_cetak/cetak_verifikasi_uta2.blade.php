...
<html>
<head>
<title>Cetak Verifikasi Syarat Komprehensif TA</title>
</head>
...
<table border="0">
  ...
  <p align="center"><u><strong>Syarat-syarat Komprehensif Tugas Akhir</strong></u></p>
  <table width="768" border="1">
    ...
    <tr>
      ...
      <td><div align="center">{!!$pengajuanUjian->ksmktm!!}</div></td>
    </tr>
    <tr>
      ...
      <td><div align="center">{!!$pengajuanUjian->biaya_ujian!!}</div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><div align="center">{!!$pengajuanUjian->sertifikat!!}</div></td>
    </tr>
    <tr>
      <td><div align="center">5. </div></td>
      <td><div align="justify">Fotocopy/legalisir sertificate nilai SULIET minimal 500</div></td>
      <td><div align="center">{!!$pengajuanUjian->suliet!!}</div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><div align="center"></div>{!!$pengajuanUjian->rekomendasi!!}</td>
    </tr>
    <tr>
      <td><div align="center">8. </div></td>
      <td><div align="justify">Melampirkan Form Perbaikan Ujian Tugas Akhir Akhir I</div></td>
      <td><div align="center">{!!$pengajuanUjian->form_ta1!!}</div></td>
    </tr>
    <tr>
      ...
      <td><div align="center">{!!$pengajuanUjian->eksemplar!!}</div></td>
    </tr>
    <tr>
