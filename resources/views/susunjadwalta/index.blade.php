...
<td><a href='{!! url("susunjadwalta/jadwal/$p->nim/$jenista")!!}' data-toggle="modal" data-target="#myModal" >Susun Jadwal</a> - <a href='{!! url("susunjadwalta/penguji/$p->nim/$jenista")!!}' data-toggle="modal" data-target="#myModal">Penguji</a> </td>
</tr>
@endforeach
</tbody>
</table>
