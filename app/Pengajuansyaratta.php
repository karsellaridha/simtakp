...
class Pengajuansyaratta extends Model {
	...
	protected $fillable	= ['nim','no_hp','id_pengajuan_pembta','jumlah_sks','id_transaksispp','id_transaksidpl','ktm','proposal_ta','tanda_kp','kesediaan_membimbing','persetujuan_ta','sk_pemb','permohonan_ambildata','status_syaratta'];
